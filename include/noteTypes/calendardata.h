...
constexpr uint16_t CCAL_VERSION = 1;
...
struct MoonDefinition {
    ...
    double  epochDayOffset  = 0.0; // phase shift from day 0
};
...
struct CalendarConfigData {
    ...
    int                      weekLength = 7;
    QVector<QString>         dayNames; // size = weekLength
    QVector<MonthDefinition> months; // size = monthsPerYear
