...
public:
    explicit DaySlot(QWidget *parent = nullptr, int _dayNumber = 0, int _weekday = 0, int _thisDaysLinks = 0, QList<double> *_moonsPhases = new QList<double>, QList<QString> *_moonsColors = new QList<QString>, const LeapDayDefinition* LeapDayDef = nullptr);
    ~DaySlot();
    ...
    int weekday;
    int thisDaysLinks;
    const LeapDayDefinition* leapDayDef;
